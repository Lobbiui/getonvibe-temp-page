...
const faqs = [
  {
    ...
    answer:
      "ONVIBE Festival is planned for the Nashville Area with a target date of October 17, 2026. The official venue announcement and event details will be released to registered subscribers first.",
  },
  {
