...
export function HotelPartnerships() {
  return (
    <Section
      ...
      copy="ONVIBE Festival is connecting with Nashville-area hotels interested in supporting attendee lodging for the October 10 launch event. Hotels can inquire about room blocks, discounted attendee rates, preferred lodging visibility, shuttle coordination, hospitality packages, and official partnership opportunities."
    >
